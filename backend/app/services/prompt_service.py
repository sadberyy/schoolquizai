...
5a. **no_distractors** (warning) — среди вариантов ответа нет дистракторов:
 все неправильные варианты очевидно ложные или абсурдные. 
 Хотя бы в одном вопросе викторины должны быть правдоподобные дистракторы — варианты, которые отражают типичные ошибки учеников данного класса по этой теме.
