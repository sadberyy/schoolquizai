...
- **ИИ под российскую школу** — предмет, класс, сложность, типы вопросов; проверка и доработка сгенерированной викторины перед сохранением и после
- **Один цикл для учителя** — папки, поиск викторин, редактор, показ в классе, ссылка для ученика, результаты и тепловая карта, экспорт в PDF / PPTX / DOCX
- **Формулы и картинки** — LaTeX в вопросах, изображения к заданиям, указание источника (в т.ч. с загруженного скрина)
- **Без установки у ученика** — прохождение по ссылке, только имя; режим крупного шрифта для доступности
...
- генерация викторин из текста, файлов (PDF, PPTX, DOCX, TXT) и изображений (JPG, PNG, WebP, фото/скрин);
- папки, поиск, редактирование, показ, результаты с тепловой картой, экспорт;
